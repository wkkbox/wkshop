            ...
            <tr>
                ...
                <td>
                    <input class="easyui-numberbox" type="text" id="priceView" name="priceView"
                           data-options="required:true,min:0,precision:2"><%--小数点两位--%>
        ...
        $('#itemAddForm').form('submit', {
            ...
            onSubmit: function () {
                ...
                $liList.each(function (i, e) {
                    ...
                    var params = [];
                    var $trParams = $(e).find('tr').has('td.param');//含有td且class=param的tr
                    $trParams.each(function (_i, _e) {
                        var $oneDataTr = $(_e);//某一个tr
            ...
            success: function (data) {
                ...
                if (data > 0) {
                    ...
                    $.messager.alert('消息', '添加商品失败！', 'warning');
                }
            }
        });
    }
                    ...
                    function (data) {
                        ...
                        if (data) {
                            ...
                            $.each(paramData, function (index, item) {
                                ...
                                //遍历分组项
                                if (item.params) {
                                    $.each(item.params, function (_i, paramName) {
